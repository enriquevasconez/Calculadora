...
public class Calcu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton20.setText("Hx");

        jButton21.setText("DC");
        jButton21.setActionCommand("");

        jButton22.setText("OC");

        jButton23.setText("BN");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        } else if(!Punto(jTextArea1.getText())){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String respuesta;
        numero2=jTextArea1.getText();
        if(!numero2.equals(" ")){
            respuesta=calculando(numero1, numero2, signo);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         ...
         p=jTextArea1.getText();
         if(p.length()>0){
              num=-1*Double.parseDouble(p);
              jTextArea1.setText(num.toString());
         }
    ...
    public static String calculando(String numero1, String numero2, String signo){
        Double resul=0.0;
        String respuesta;
        if(signo.equals("-")){
    ...
    public boolean Punto(String jTextArea1){
        boolean respuesta;
        respuesta=false;
        for(int i=0;i<jTextArea1.length();i++){
            if(jTextArea1.substring(i,i+1).equals(".")){
                respuesta=true;
                break;
            }
        } return respuesta;
